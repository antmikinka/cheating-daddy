...
function buildSystemPrompt(promptParts, customPrompt = '', googleSearchEnabled = true) {
    if (!promptParts || typeof promptParts !== 'object') {
        console.error('Invalid promptParts provided to buildSystemPrompt');
...
function getSystemPrompt(profile, customPrompt = '', googleSearchEnabled = true) {
    try {
        if (!profile || typeof profile !== 'string') {
            console.warn('Invalid profile provided, using default interview profile');
            profile = 'interview';
        }

        const promptParts = profilePrompts[profile.toLowerCase()] || profilePrompts.interview;
        
        if (!promptParts) {
            console.error(`No prompt parts found for profile: ${profile}, using interview default`);
            return buildSystemPrompt(profilePrompts.interview, customPrompt, googleSearchEnabled);
        }
